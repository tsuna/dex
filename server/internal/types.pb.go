...
func (*RefreshToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_2bc4f1e35e7e7905, []int{0}
}
...
func (*IDTokenSubject) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_2bc4f1e35e7e7905, []int{1}
}
...
func (dst *IDTokenSubject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IDTokenSubject.Merge(dst, src)
}
...
func init() { proto.RegisterFile("server/internal/types.proto", fileDescriptor_types_2bc4f1e35e7e7905) }

var fileDescriptor_types_2bc4f1e35e7e7905 = []byte{
